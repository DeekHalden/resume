...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.classList.add("images-responsive");
...
var resizePizzas = function(size) { 
  ...
  function changeSliderLabel(size) {
    switch(size) {
      ...
      case "3":
        ...
        return;
      case "4":
      	document.getElementById("pizzaSize").innerHTML = "Xl";
      	return;
      default:
  ...
  changeSliderLabel(size);
   ...
   // Changes the slider value to a percent width
    ...
    // Loops quantity of pizzas and returnes new size of them  
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var rows = scrHeight / 100;
    
  var numberOfMovers = cols * rows;
  
  console.log(numberOfMovers);
